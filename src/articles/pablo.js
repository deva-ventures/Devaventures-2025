...
>
  ...
  <a
    href="https://youtu.be/-oq8VYhFcHw?si=AOt9MspYjPB8oLBN"
    target="_blank"
    rel="noopener noreferrer"
  ...
  onClick={() => {
    window.open("https://youtu.be/-oq8VYhFcHw?si=AOt9MspYjPB8oLBN", "_blank");
  }}
>
  Learn More
</Button>
...
>
  ...
  >
    <img
      src="/pabloConvo.jpg" // replace with your image path
      alt="Personality"
      style={{
        width: "100%",
        maxWidth: "550px",
